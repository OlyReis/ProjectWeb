		...
		<div id="page-content-wrapper">
			<div class="container-fluid">
				...
				<div class="row-mb-5" style="display: inline-flex;">
					<div class="col-sm-4">
						<div class="card">
							<img class="card-img-top" src="img/294430.jpg" style="width: 100%; height: 200px;">
							<div class="card-body">
					...
					<div class="col-sm-4">
						<div class="card">
							<img class="card-img-top" src="img/terra.jpg"style="width: 100%; height: 200px;">
							<div class="card-body">
								<h4 class="card-titile"> Nome</h4>
							</div>
							<ul class="list-group list-group-flush">
					...
					<div class="col-sm-4">
						<div class="card">
							<img class="card-img-top" src="img/tigre.jpg" style="width: 100%; height: 200px;">
							<div class="card-body">
								<h4 class="card-titile"> Nome</h4>
							</div>
							<ul class="list-group list-group-flush">
