              ...
              <div class="col-sm-4">
                <div class="card">
                  ...
                  <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item font-weight-bold mx-auto"><a href="#"  style="color: red;"><svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" fill="currentColor" class="bi bi-x" viewBox="0 0 16 16" style="margin-left: -6px;">
